...
del t3
time.sleep(10)  
# Now Test() is eligible for GC, Obj destroyed after 10 secs controller reaches EOA
# but t4 = Test() still have reference. so after 10sec at EOA - All objs are eligilble for GC, So destructor executed
